...
import UseOnClickOutside from '../../../lib/utils/useonClickOutside.util';
...
export default function Dropdown({ value, placeholder, setValue, data }: Props) {
    ...
    return (
        <div ref={ref} className={`relative border border-slate-500 rounded-lg px-4 py-2 w-full outline-none focus:border-primary-blue`}>
